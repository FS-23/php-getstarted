<?php
  ...
  foreach($players as $index => $player){
      ...
      if(strtolower($begin) == 'o'){
           for($i = 1 ; $i<=5 ;$i++){
               $randValue = rand(1,5);
               $result = readline("Tentative $i. Veuillez entrer un nombre entre 1 et 5:");
               ...
               if($result == $randValue){
                    $player->score += 40;
                    echo "\nBien jouer vous avez gagner 40 pts. Score total:". $player->score."\n";
               }else{
                   echo "\nOpps manqué \n\n";
               }
           }
           ...
           if($player ->score >= 100 ){
              echo "\nBien jouer vous passez au niveau des champions. score total:". $player->score;
